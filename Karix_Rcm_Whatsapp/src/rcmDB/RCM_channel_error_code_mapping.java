...
public class RCM_channel_error_code_mapping extends BaseProperties {

	@Test
	public static void  read_rcm_channel_error_code_mapping_table() throws  SQLException, ClassNotFoundException, IOException {													
		...
		//Query to Execute		
		String query = "SELECT * FROM rcm_channel_error_code_mapping";	
