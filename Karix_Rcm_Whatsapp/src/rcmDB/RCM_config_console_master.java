...
public class RCM_config_console_master extends BaseProperties {

	
	@Test
	public static void  read_rcm_config_console_master_table() throws  SQLException, ClassNotFoundException, IOException {													
		...
		//Query to Execute		
		String query = "SELECT * FROM rcm_config_console_user where password like \"%user\" ";
