...
public class RCM_cluster_master extends BaseProperties {
	@Test
	public static void  read_rcm_cluster_master_table() throws  SQLException, ClassNotFoundException, IOException {													
		...
		//Query to Execute		
		String query = "SELECT * FROM rcm_cluster_master WHERE cluster_id >2 ";	
